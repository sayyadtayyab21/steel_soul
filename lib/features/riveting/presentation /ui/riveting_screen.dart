...
class Riveting {
  ...
  Riveting(this.id, this.date);
}

// Dummy Project List
final List<Riveting> dummyProjects = [
  Riveting('PJT-00001', '25-01-2025'),
  Riveting('PJT-00332', '22-01-2025'),
  Riveting('PJT-00004', '20-01-2025'),
  Riveting('PJT-00006', '21-01-2025'),
  Riveting('PJT-00008', '19-01-2025'),
];
    ...
    return Scaffold(
              ...
              child: TextField(
                decoration: InputDecoration(
                 ...
                 prefixIcon: Padding(
                          ...
                          child: Icon(Icons.search,color: Color(0xFF3181ff),) // Used primary color
                        ),
                    ...
                    child: RivetingCards(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => RivetingItemDetails(),
                          ),
                        );
                      },
                    ),
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          backgroundColor:Color(0xFF3181ff),
