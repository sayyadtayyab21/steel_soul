...
//   const RivetingItemDetails({super.key});
...
import 'package:steel_soul/features/riveting/presentation%20/ui/riveting_scan_details.dart' show RivetingScanDetails;
                              ...
                              child: RivetingItemCards(
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => RivetingScanDetails(projectId: widget.id, unit: project.unitCode ?? '',),
                                    ),
                                  );
                                },
                              ),
    ...
    return Container(
      ...
      child: const TextField(
        decoration: InputDecoration(
          ...
          prefixIcon:
              Icon(Icons.search, color: Color(0xFF3181ff)),
          border: InputBorder.none,
          contentPadding:
