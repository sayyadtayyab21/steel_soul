...
class RivetingScanDetails extends StatefulWidget {
  const RivetingScanDetails({
    super.key,
  ...
  @override
  State<RivetingScanDetails> createState() => _RivetingScanDetailsState();
}
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (_) =>
              RivetingBlocProvider.get().fetchLaserScanList()
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: SummaryBox(
                                      borderColor: const Color(0xFF3181ff),
