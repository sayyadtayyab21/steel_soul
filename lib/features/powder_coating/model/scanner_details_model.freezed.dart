...
class _$SacnnerDetailsModelImpl extends _SacnnerDetailsModel {
  ...
  @override
  String toString() {
    return 'SacnnerDetailsModel(name: $name, panelName: $panelName, project: $project, unit: $unit, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, panelName, project, unit, status);
