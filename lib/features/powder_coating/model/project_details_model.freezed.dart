...
abstract class $ProjectDetailsModelCopyWith<$Res> {
  factory $ProjectDetailsModelCopyWith(
    ProjectDetailsModel value,
    $Res Function(ProjectDetailsModel) then,
...
abstract class _$$ProjectDetailsModelImplCopyWith<$Res>
    implements $ProjectDetailsModelCopyWith<$Res> {
  factory _$$ProjectDetailsModelImplCopyWith(
    _$ProjectDetailsModelImpl value,
...
class __$$ProjectDetailsModelImplCopyWithImpl<$Res>
  ...
  __$$ProjectDetailsModelImplCopyWithImpl(
    _$ProjectDetailsModelImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$ProjectDetailsModelImpl extends _ProjectDetailsModel {
  ...
  @override
  String toString() {
    return 'ProjectDetailsModel(name: $name, customerName: $customerName, projectId: $projectId, date: $date, time: $time, customerPhoneNumber: $customerPhoneNumber, status: $status)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ProjectDetailsModelImplToJson(this);
  }
}

abstract class _ProjectDetailsModel extends ProjectDetailsModel {
  ...
  const _ProjectDetailsModel._() : super._();
