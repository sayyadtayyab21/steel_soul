...
// Dummy Project List
final List<Floding> dummyProjects = [
  Floding('001 TV1'),
   Floding('001 TV1'),
   Floding('001 TV1'),
 Floding('001 TV1'),
...
class FoldingItemDetails extends StatefulWidget {
  const FoldingItemDetails({super.key});
              ...
              child: TextField(
                decoration: InputDecoration(
                 ...
                 prefixIcon: const Padding(
                          ...
                          child: Icon(Icons.search,color: Color(0xFFFF7f7e),) // Used primary color
                        ),
                    ...
                    child: FoldingItemCards(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => FoldingScanDetails(projectId: project.id),
                          ),
                        );
                      },
                    ),
