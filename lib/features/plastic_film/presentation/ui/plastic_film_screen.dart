...
class PlasticFilm {
  ...
  PlasticFilm(this.id, this.date);
}

// Dummy Project List
final List<PlasticFilm> dummyProjects = [
  PlasticFilm('PJT-00001', '25-01-2025'),
  PlasticFilm('PJT-00332', '22-01-2025'),
  PlasticFilm('PJT-00004', '20-01-2025'),
  PlasticFilm('PJT-00006', '21-01-2025'),
  PlasticFilm('PJT-00008', '19-01-2025'),
];


class PlasticFilmScreen extends StatefulWidget {
  const PlasticFilmScreen({super.key});

  @override
  State<PlasticFilmScreen> createState() => _PlasticFilmScreenState();
}
              ...
              child: TextField(
                decoration: InputDecoration(
                 ...
                 prefixIcon: Padding(
                          ...
                          child: Icon(Icons.search,color:Color(0xFF8490ff),) // Used primary color
                        ),
                    ...
                    child: PlasticFilmsCards(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PlasticFilmItemDetails(),
                          ),
                        );
                      },
                    ),
