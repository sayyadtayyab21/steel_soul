...
class _$OcrDataImpl implements _OcrData {
  const _$OcrDataImpl({@JsonKey(name: 'texts') final List<String>? texts})
    : _texts = texts;
...
abstract class _OcrData implements OcrData {
  const factory _OcrData({@JsonKey(name: 'texts') final List<String>? texts}) =
      _$OcrDataImpl;
