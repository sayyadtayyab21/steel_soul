...
import 'package:steel_soul/features/puf/presentation/widgets/puf_cards.dart';
...
class Puf{
  ...
  Puf(this.id, this.date);
}

// Dummy Project List
final List<Puf> dummyProjects = [
  Puf('PJT-00001', '25-01-2025'),
  Puf('PJT-00332', '22-01-2025'),
  Puf('PJT-00004', '20-01-2025'),
  Puf('PJT-00006', '21-01-2025'),
  Puf('PJT-00008', '19-01-2025'),
];


class PufScreen extends StatefulWidget {
  const PufScreen({super.key});

  @override
  State<PufScreen> createState() => _PufScreenState();
}

class _PufScreenState extends State<PufScreen> {
    ...
    return Scaffold(
                    ...
                    child: PufCards(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => PufItemDetails(),
                          ),
                        );
                      },
                    ),
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          backgroundColor:Color(0xFF1ad0d0),
