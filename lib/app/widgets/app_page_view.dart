    ...
    return Stack(
      ...
      children: [
        Positioned(
          left: 52,
          top: -24,
          child: Image.asset(AppIcons.info.path, alignment: Alignment.topRight, fit: BoxFit.cover,height: 210),
        ),
        Positioned(
          left: 18,
          right: 8,
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SvgPicture.asset(AppIcons.info.path, alignment: Alignment.topRight),
      ],
    );
  }
}
