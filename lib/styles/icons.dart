...
class AppIcons {
  ...
  static const helloCuate = AppIcon('$basePath/logo/bg_frame_1.png'); // Temporarily using PNG instead of SVG
  ...
  static const settingsCuate = AppIcon('$basePath/logo/bg_frame_2.png'); // Temporarily using PNG instead of SVG
